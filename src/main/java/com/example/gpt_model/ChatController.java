...
public class ChatController {
    ...
    @PostMapping("/chat/idea1")
    public Map<String, String> chat1(@RequestBody Map<String, String> request) {
        try {
    ...
    @PostMapping("/chat/idea2")
    public Map<String, String> chat2(@RequestBody Map<String, String> request) {
        try {
            String userMessage = request.get("message");
    ...
    public Map<String, String> chat3(@RequestBody Map<String, String> request) {
        try {
            String userMessage = request.get("message");
